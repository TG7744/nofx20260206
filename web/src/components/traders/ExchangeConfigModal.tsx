...
type ExchangeTemplateType = 'cex' | 'dex' | 'paper'
// Supported exchange templates
const SUPPORTED_EXCHANGE_TEMPLATES: {
  exchange_type: string
  name: string
  type: ExchangeTemplateType
}[] = [
  { exchange_type: 'paper', name: 'Paper Trading', type: 'paper' },
...
export function ExchangeConfigModal({
  ...
  const paperExchanges = SUPPORTED_EXCHANGE_TEMPLATES.filter(
    (t) => t.type === 'paper'
  )
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div
                    ...
                    style={{ color: '#A0AEC0' }}
                  >
                    {language === 'zh' ? '模拟交易所' : 'Paper Trading'}
                  </div>
