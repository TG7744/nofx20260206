#!/bin/bash
#
# NOFX One-Click Installation Script (Dev/Test)
...
#   curl -fsSL https://raw.githubusercontent.com/TG7744/nofx20260206/dev/install-dev.sh | bash -s -- /opt/nofx
#
...
print_success() {
    ...
    echo -e "╚════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo -e "  ${GREEN}curl -fsSL https://raw.githubusercontent.com/TG7744/nofx20260206/dev/install-dev.sh | bash${NC}"
    echo ""
