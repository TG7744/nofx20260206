...
func (tm *TraderManager) addTraderFromStore(traderCfg *store.Trader, aiModelCfg *store.AIModel, exchangeCfg *store.Exchange, st *store.Store) error {
	...
	traderConfig := trader.AutoTraderConfig{
		...
		PaperFeeRate:          exchangeCfg.PaperFeeRate,
		PaperSlippageBps:      exchangeCfg.PaperSlippageBps,
		PaperPriceSource:      exchangeCfg.PaperPriceSource,
		EnableDrawdownGuard:   traderCfg.EnableDrawdownGuard,
		DrawdownMinProfitPct:  traderCfg.DrawdownMinProfitPct,
